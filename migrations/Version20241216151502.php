 ...
 */
final class Version20241216151502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD utilisateur_id INT DEFAULT NULL, DROP session_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_item (id INT AUTO_INCREMENT NOT NULL, cart_id INT NOT NULL, produit_id INT NOT NULL, quantite INT NOT NULL, total DOUBLE PRECISION NOT NULL, INDEX IDX_F0FE2527F347EFB (produit_id), INDEX IDX_F0FE25271AD5CDBF (cart_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE cart ADD session_id VARCHAR(255) DEFAULT NULL, DROP utilisateur_id');
    }
}
